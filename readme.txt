...
<h3> Method 2</h3>or use short code <code>[wplfta_login_form]</code> to your page or post or text widget 
<h3> Method 3</h3>to use in theme use <code>&lt;?php echo do_shortcode('[wplfta_login_form]'); ?&gt;</code> to your template 
